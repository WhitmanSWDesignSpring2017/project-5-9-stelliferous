...
public class MidiPlayer {
     ...
     * @param trackIndex the index of the track to which the new event will be added
     */
     ...
     * @param channel an integer from 0 to 15; each channel typically corresponds 
     * to a different instrument.  The default instrument for all channels is 
     * the grand piano.
